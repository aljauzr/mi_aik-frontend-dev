...
<head>
  <meta charset="utf-8">
  <title>Detail Berita - <?php echo htmlspecialchars($data['nama']); ?></title>
  <meta content="Detail Berita - <?php echo htmlspecialchars($data['nama']); ?>" property="og:title">
  <meta content="Detail Berita - <?php echo htmlspecialchars($data['nama']); ?>" property="twitter:title">
  ...
  <script>
    document.addEventListener('DOMContentLoaded', function() {
      ...
      gambarElement.src = gambarSrc && gambarSrc !== 'null' 
          ...
          : backend_url + 'images/defaultBerita.jpg';
